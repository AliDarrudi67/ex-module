...
@Component({
  selector: 'app-staking-currency-form',
  standalone: true,
  imports: [
    FormsModule,
    ReactiveFormsModule,
  ...
  templateUrl: './staking-currency-form.component.html',
  styleUrl: './staking-currency-form.component.scss',
})
export class StakingCurrencyFormComponent {
  form!: FormGroup;
  formTitle = 'ارز staking';
